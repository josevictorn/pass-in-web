    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="border border-white/10 rounded-lg">
        <table className="w-full">
            ...
            {Array.from({ length: 8 }).map((_, i) => {
              return (
                <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                  ...
                  <td className="py-3 px-4 text-sm text-zinc-50">12383</td>
                  ...
                  <td className="py-3 px-4 text-sm text-zinc-50">7 dias atrás</td>
                  <td className="py-3 px-4 text-sm text-zinc-50">2 dias atrás</td>
                  <td className="py-3 px-4 text-sm text-zinc-50">
          ...
          <tfoot>
            <tr>
              <td colSpan={3} className="py-3 px-4 text-sm text-zinc-50">
                Mostrando 10 de 228 itens
              </td>
              <td colSpan={3} className="py-3 px-4 text-sm text-zinc-50 text-right">
